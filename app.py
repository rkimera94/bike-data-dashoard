...
fig_2.add_trace(
go.Scatter(x = df['date'], y = df['value'], name = 'Daily bike rides', marker={'color': df['value'],'color': 'blue'}),
secondary_y = False
)
...
path_to_html = os.path.join(path, 'New York Bike Trips Aggregated.html')
